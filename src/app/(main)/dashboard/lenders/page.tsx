...
/*
 ...
 - File: app/(main)/dashboard/lenders/page.tsx
 - Purpose: Next.js page for /dashboard/lenders.
 ...
 - Local imports: @/components/data-table/simple-data-table, @/components/ui/button, @/components/ui/input, @/components/ui/card, @/components/ui/skeleton, @/components/ui/select, @/components/ui/dialog, @/hooks/useLenders, @/components/lenders/LenderForm, ./_components/columns, @/types/lender
