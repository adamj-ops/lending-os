...
/*
 ...
 - File: app/(main)/dashboard/_components/sidebar/layout-controls.tsx
 - Purpose: Module layout-controls.tsx supporting application features.
 ...
 - Local imports: @/components/ui/button, @/components/ui/label, @/components/ui/popover, @/components/ui/select, @/components/ui/toggle-group, @/lib/layout-utils, @/lib/theme-utils, @/server/server-actions, @/stores/preferences/preferences-provider, @/types/preferences/layout, @/types/preferences/theme
