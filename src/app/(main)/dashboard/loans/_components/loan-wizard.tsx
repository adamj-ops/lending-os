...
/*
 ...
 - File: app/(main)/dashboard/loans/_components/loan-wizard.tsx
 - Purpose: Module loan-wizard.tsx supporting application features.
 ...
 - External imports: react, react-hook-form, @hookform/resolvers/zod, framer-motion, sonner
 - Local imports: @/components/ui/dialog, @/components/ui/button, @/components/ui/progress, @/features/loan-builder/schemas, @/features/loan-builder/store, @/features/loan-builder/types, @/features/loan-builder/motion.config, @/features/loan-builder/steps/StepCategory, @/features/loan-builder/steps/StepParty, @/features/loan-builder/steps/StepAsset, ./wizard-steps/loan-terms-step, ./wizard-steps/documents-step
