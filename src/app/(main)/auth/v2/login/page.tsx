/*
 ...
 - File: app/(main)/auth/v2/login/page.tsx
 - Purpose: Next.js page for /auth/v2/login.
 ...
 - Local imports: @/config/app-config, ../../_components/login-form, ../../_components/social-auth/google-button
