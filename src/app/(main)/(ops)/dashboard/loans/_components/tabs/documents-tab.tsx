...
import { IconDownload, IconTrash, IconFileText, IconPlus } from "@tabler/icons-react";
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="flex h-32 flex-col items-center justify-center">
              <IconFileText size={20} stroke={2} className="mb-2 size-12 text-muted-foreground" />
              ...
              {documents.map((doc) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <IconFileText size={20} stroke={2} className="size-8 text-muted-foreground" />
                    <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      <a href={doc.fileUrl} target="_blank" rel="noopener noreferrer">
                        <IconDownload size={20} stroke={2} className="size-4" />
                      </a>
                    </Button>
                    <Button
                      variant="ghost"
