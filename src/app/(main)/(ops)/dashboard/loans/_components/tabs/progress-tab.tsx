...
import { IconTrendingUp, IconCalendar, IconCurrencyDollar, IconPercentage } from "@tabler/icons-react";
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-lg border p-4">
              <div className="flex items-center gap-2">
                <IconCurrencyDollar size={20} stroke={2} className="size-4 text-muted-foreground" />
            ...
            <div className="rounded-lg border p-4">
              <div className="flex items-center gap-2">
                <IconCalendar size={20} stroke={2} className="size-4 text-muted-foreground" />
                <p className="text-sm font-medium text-muted-foreground">
                  Days to Maturity
                </p>
              </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex h-32 flex-col items-center justify-center">
            <IconTrendingUp size={20} stroke={2} className="mb-2 size-12 text-muted-foreground" />
