...
import { IconExternalLink, IconMapPin, IconCurrencyDollar, IconHome } from "@tabler/icons-react";
  ...
  if (!loan.property) {
    return (
      <div className="flex h-64 flex-col items-center justify-center">
        <IconHome size={20} stroke={2} className="mb-4 size-12 text-muted-foreground" />
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          <div className="md:col-span-2">
            <div className="flex items-start gap-2">
              <IconMapPin size={20} stroke={2} className="mt-1 size-4 text-muted-foreground" />
              <div>
