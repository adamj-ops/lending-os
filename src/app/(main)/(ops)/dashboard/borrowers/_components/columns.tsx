...
import { IconDots, IconMail, IconPhone, IconBuilding, IconTrash, IconEdit } from "@tabler/icons-react";
        ...
        <div>
          ...
          {companyName && type === "individual" && (
            <div className="text-muted-foreground flex items-center gap-1 text-sm">
              <IconBuilding size={20} stroke={2} className="size-3" />
              {companyName}
            </div>
          )}
        </div>
      ...
      return (
        <div className="space-y-1">
          <div className="flex items-center gap-1 text-sm">
            <IconMail size={20} stroke={2} className="size-3" />
            {email}
          </div>
          {phone && (
            <div className="text-muted-foreground flex items-center gap-1 text-sm">
              <IconPhone size={20} stroke={2} className="size-3" />
              {phone}
            </div>
          )}
        </div>
