...
import { IconCircleCheck, IconCurrencyDollar, IconFileText } from "@tabler/icons-react";
        ...
        <div className="space-y-4">
          {recentActivities.map((activity) => (
            <div key={activity.id} className="flex items-start gap-3">
              <div className="flex size-10 shrink-0 items-center justify-center rounded-full border border-border">
                <activity.icon size={20} stroke={2} className="text-foreground" />
              </div>
