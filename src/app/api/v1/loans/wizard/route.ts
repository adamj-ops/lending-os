/*
 ...
 - File: app/api/v1/loans/wizard/route.ts
 - Purpose: HTTP route handlers for v1/loans/wizard (App Router API).
 ...
 - Local imports: @/db/client, @/db/schema, @/types/loan-document
