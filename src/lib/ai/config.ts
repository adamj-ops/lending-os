/*
 ...
 - How it works: Collects stateless helpers for formatting, configuration, I/O, or integration. Uses: Zod, ai-sdk.
 - External imports: @ai-sdk/openai, @ai-sdk/anthropic, ai, zod
