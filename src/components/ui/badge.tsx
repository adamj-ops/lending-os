  ...
  'inline-flex items-center whitespace-nowrap justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0',
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        appearance: 'light',
        className:
          'text-[var(--color-success-accent,var(--color-green-600))] bg-transparent border border-[var(--color-success-accent,var(--color-green-600))] dark:text-[var(--color-success-accent,var(--color-green-400))] dark:border-[var(--color-success-accent,var(--color-green-400))]',
      },
      {
        variant: 'warning',
        appearance: 'light',
      ...
      },
      {
        ...
        appearance: 'light',
        className:
          'text-[var(--color-destructive-accent,var(--color-red-600))] bg-transparent border border-[var(--color-destructive-accent,var(--color-red-600))] dark:text-[var(--color-destructive-accent,var(--color-red-400))] dark:border-[var(--color-destructive-accent,var(--color-red-400))]',
      },
      /* Outline */
      {
        variant: 'primary',
