...
const cardVariants = cva('flex flex-col items-stretch text-card-foreground rounded-xl', {
  variants: {
    variant: {
      ...
      accent: 'bg-[var(--surface-alt)] shadow-sm p-1',
    },
  },
  defaultVariants: {
    variant: 'default',
...
const cardHeaderVariants = cva('flex items-center justify-between flex-wrap p-6 gap-2', {
  variants: {
    variant: {
...
const cardFooterVariants = cva('flex items-center p-6 min-h-14', {
  variants: {
    variant: {
      default: 'border-t border-[var(--border-subtle)]',
...
// Exports
export { Card, CardAction, CardContent, CardDescription, CardFooter, CardHeader, CardHeading, CardTable, CardTitle, CardToolbar };
