    ...
    return (
      <div className="flex items-center justify-center p-8">
        <div className="text-center">
          ...
          <p className="text-brand-muted">Loading inspection...</p>
        </div>
      </div>
    );
  }
    ...
    <div className={cn("max-w-md mx-auto p-4 space-y-4", className)}>
        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {isOnline ? (
                <IconWifi size={16} stroke={2} className="h-4 w-4 text-brand-success" />
              ) : (
                <IconWifiOff size={16} stroke={2} className="h-4 w-4 text-brand-danger" />
              )}
              {!inspection.synced && (
      ...
      {!isOnline && (
        <div className="fixed top-4 left-4 right-4 bg-yellow-100 border border-yellow-400 rounded-lg p-3">
          <div className="flex items-center gap-2">
            <IconAlertCircle size={20} stroke={2} className="h-4 w-4 text-brand-accent" />
