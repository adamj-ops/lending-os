...
export function AIPaymentAnalysis({
  ...
  const getTrendIcon = (trend: string) => {
    switch (trend) {
      case 'increasing': return <IconTrendingUp size={20} stroke={2} className="h-4 w-4 text-green-600" />;
      case 'decreasing': return <IconTrendingDown size={20} stroke={2} className="h-4 w-4 text-red-600" />;
      default: return <IconTrendingUp size={20} stroke={2} className="h-4 w-4 text-gray-600" />;
    }
  };
        ...
        <CardContent>
          <div className="flex items-center justify-center py-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Analyzing payment patterns...</p>
            </div>
          </div>
        </CardContent>
      </Card>
    ...
    <div className={cn("space-y-6", className)}>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Based on payment patterns and history</p>
            </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center p-4 border rounded-lg">
              <div className="flex items-center justify-center gap-2 mb-2">
                <IconClock size={20} stroke={2} className="h-4 w-4 text-green-600" />
          ...
          <div className="space-y-3">
            {analysis.recommendations.map((recommendation, index) => (
              <div key={index} className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                <IconRobot size={16} stroke={2} className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 border rounded-lg">
              <h4 className="font-medium text-gray-600 mb-1">Next Payment</h4>
            ...
            <div className="text-center p-4 border rounded-lg">
              <h4 className="font-medium text-gray-600 mb-1">Expected Amount</h4>
              <p className="text-lg font-bold">
            ...
            <div className="text-center p-4 border rounded-lg">
              <h4 className="font-medium text-gray-600 mb-1">Confidence</h4>
