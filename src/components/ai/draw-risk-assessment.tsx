...
export function AIDrawRiskAssessment({
  ...
  const getImpactIcon = (impact: string) => {
    switch (impact) {
      case 'high': return <IconAlertTriangle size={20} stroke={2} className="h-4 w-4 text-red-600" />;
      case 'medium': return <IconAlertTriangle size={20} stroke={2} className="h-4 w-4 text-yellow-600" />;
      case 'low': return <IconCircleCheck size={20} stroke={2} className="h-4 w-4 text-green-600" />;
      default: return <IconCircleCheck size={20} stroke={2} className="h-4 w-4 text-gray-600" />;
    }
  };
  ...
  const getApprovalIcon = (recommendation: string) => {
    switch (recommendation) {
      case 'approve': return <IconCircleCheck size={20} stroke={2} className="h-5 w-5 text-green-600" />;
      case 'approve_with_conditions': return <IconAlertTriangle size={20} stroke={2} className="h-5 w-5 text-yellow-600" />;
      case 'reject': return <IconAlertTriangle size={20} stroke={2} className="h-5 w-5 text-red-600" />;
      case 'request_more_info': return <IconBrain size={20} stroke={2} className="h-5 w-5 text-blue-600" />;
      default: return <IconBrain size={20} stroke={2} className="h-5 w-5 text-gray-600" />;
    }
  };
        ...
        <CardContent>
          <div className="flex items-center justify-center py-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Assessing draw risk factors...</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className={className}>
        ...
        <CardContent>
          <div className="text-center py-8">
            <IconRobot size={48} stroke={2} className="h-12 w-12 text-gray-400 mx-auto mb-4" />
  ...
  return (
    <div className={cn("space-y-6", className)}>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Based on draw amount, timing, and project progress</p>
            </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <IconAlertTriangle size={20} stroke={2} className="h-5 w-5 text-yellow-600" />
            Risk Factors
          </CardTitle>
        </CardHeader>
        <CardContent>
...
export function AIDrawAnalysisSummary({ draws, className }: AIDrawAnalysisSummaryProps) {
    ...
    return (
      <Card className={className}>
        <CardContent className="text-center py-8">
          ...
          <p className="text-sm text-gray-600">Generating analysis summary...</p>
        </CardContent>
      </Card>
    );
  }
  ...
  if (!summary) {
    return (
      <Card className={className}>
        <CardContent className="text-center py-8">
          <IconRobot size={32} stroke={2} className="h-8 w-8 text-gray-400 mx-auto mb-2" />
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="text-2xl font-bold text-green-600">{summary.approvedDraws}</div>
              <div className="text-sm text-gray-600">Approved</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-red-600">{summary.rejectedDraws}</div>
