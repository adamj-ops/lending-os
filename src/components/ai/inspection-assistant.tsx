...
export function AIInspectionAssistant({
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      case 'safety': return <IconAlertTriangle size={20} stroke={2} className="h-4 w-4 text-red-600" />;
      case 'quality': return <IconCircleCheck size={20} stroke={2} className="h-4 w-4 text-green-600" />;
      case 'compliance': return <IconFileText size={20} stroke={2} className="h-4 w-4 text-blue-600" />;
      case 'progress': return <IconMapPin size={20} stroke={2} className="h-4 w-4 text-yellow-600" />;
      default: return <IconBulb size={16} stroke={2} className="h-4 w-4 text-gray-600" />;
    }
  };
  ...
  const getImpactIcon = (impact: string) => {
    switch (impact) {
      case 'positive': return <IconCircleCheck size={20} stroke={2} className="h-4 w-4 text-green-600" />;
      case 'negative': return <IconAlertTriangle size={20} stroke={2} className="h-4 w-4 text-red-600" />;
      case 'neutral': return <IconBrain size={16} stroke={2} className="h-4 w-4 text-gray-600" />;
      default: return <IconBrain size={16} stroke={2} className="h-4 w-4 text-gray-600" />;
    }
  };
        ...
        <CardContent>
          <div className="flex items-center justify-center py-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Analyzing inspection data...</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <CardContent>
          ...
          <div className="space-y-4">
            {recommendations.length === 0 ? (
              <div className="text-center py-8">
                <IconBulb size={32} stroke={2} className="h-8 w-8 text-gray-400 mx-auto mb-2" />
                      ...
                      <ul className="space-y-1">
                        {rec.checklistItems.map((item, itemIndex) => (
                          <li key={itemIndex} className="flex items-center gap-2 text-sm">
                            <IconCircleCheck size={20} stroke={2} className="h-3 w-3 text-green-600" />
                            {item}
                          </li>
                        ))}
                      </ul>
        ...
        {activeTab === 'insights' && (
          <div className="space-y-4">
            {insights.length === 0 ? (
              <div className="text-center py-8">
                <IconBrain size={32} stroke={2} className="h-8 w-8 text-gray-400 mx-auto mb-2" />
