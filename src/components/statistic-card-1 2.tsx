...
import { IconArrowDown, IconArrowUp, IconDots, IconPin, IconSettings, IconShare, IconTrash, IconAlertTriangle } from "@tabler/icons-react";
              ...
              <CardToolbar>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" side="bottom">
                    ...
                    <DropdownMenuItem>
                      <IconAlertTriangle size={16} stroke={2} /> Add Alert
                    </DropdownMenuItem>
                    <DropdownMenuItem>
                      <IconPin size={16} stroke={2} /> Pin to Dashboard
                    </DropdownMenuItem>
                    <DropdownMenuItem>
                      <IconShare size={16} stroke={2} /> Share
                    </DropdownMenuItem>
                    <DropdownMenuSeparator />
            ...
            <CardContent className="space-y-2.5">
              <div className="flex items-center gap-2.5">
                ...
                <Badge variant={stat.positive ? 'success' : 'destructive'} appearance="light">
                  {stat.delta > 0 ? <IconArrowUp size={20} stroke={2} /> : <IconArrowDown size={20} stroke={2} />}
                  {stat.delta}%
                </Badge>
              </div>
