/*
 ...
 - Purpose: Reusable React UI component data-table.tsx.
 ...
 - External imports: react, @dnd-kit/core, @dnd-kit/modifiers, @dnd-kit/sortable, @tanstack/react-table
 - Local imports: @/components/ui/table, ./draggable-row
