...
import { IconFileText, IconGripVertical, IconPhoto, IconMusic, IconVideo } from "@tabler/icons-react";
...
const getTypeIcon = (type: SortableItem['type']) => {
  switch (type) {
    case 'image':
      return <IconPhoto size={16} stroke={2} />;
    case 'document':
      return <IconFileText size={16} stroke={2} />;
    case 'audio':
      return <IconMusic size={16} stroke={2} />;
    case 'video':
      return <IconVideo size={16} stroke={2} />;
  }
};
